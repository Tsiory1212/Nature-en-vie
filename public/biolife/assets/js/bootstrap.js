...
+(function (t) {
    ...
    +(function (t) {
        ...
        function o(o) {
            (o && 3 === o.which) ||
                ...
                t(s).each(function () {
                    ...
                    n.hasClass("open") &&
                        ((o && "click" == o.type && /input|textarea/i.test(o.target.tagName) && t.contains(n[0], o.target)) ||
                            (n.trigger((o = t.Event("hide.bs.dropdown", s))), o.isDefaultPrevented() || (i.attr("aria-expanded", "false"), n.removeClass("open").trigger(t.Event("hidden.bs.dropdown", s)))));
                }));
        }
        function i(e) {
        ...
        (r.VERSION = "3.3.7"),
            ...
            (r.prototype.keydown = function (o) {
                if (/(38|40|27|32)/.test(o.which) && !/input|textarea/i.test(o.target.tagName)) {
                    ...
                    if ((o.preventDefault(), o.stopPropagation(), !i.is(".disabled, :disabled"))) {
                        var n = e(i),
                            r = n.hasClass("open");
                        if ((!r && 27 != o.which) || (r && 27 == o.which)) return 27 == o.which && n.find(s).trigger("focus"), i.trigger("click");
    ...
    +(function (t) {
        ...
        (o.VERSION = "3.3.7"),
            ...
            (o.prototype.enter = function (e) {
                ...
                return (
                    o || ((o = new this.constructor(e.currentTarget, this.getDelegateOptions())), t(e.currentTarget).data("bs." + this.type, o)),
            ...
            (o.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    var m = this.getCalculatedOffset(a, h, p, c);
            ...
            (o.prototype.applyPlacement = function (e, o) {
                ...
                var l = i[0].offsetWidth,
                    d = i[0].offsetHeight;
                "top" == o && d != s && (e.top = e.top + s - d);
                var h = this.getViewportAdjustedDelta(o, e, l, d);
            ...
            (o.prototype.hide = function (e) {
                ...
                return (
                    ...
                    r.isDefaultPrevented() ? void 0 : (s.removeClass("in"), t.support.transition && s.hasClass("fade") ? s.one("bsTransitionEnd", i).emulateTransitionEnd(o.TRANSITION_DURATION) : i(), (this.hoverState = null), this)
                );
            }),
            ...
            (o.prototype.toggle = function (e) {
                ...
                e && ((o = t(e.currentTarget).data("bs." + this.type)), o || ((o = new this.constructor(e.currentTarget, this.getDelegateOptions())), t(e.currentTarget).data("bs." + this.type, o))),
                    e ? ((o.inState.click = !o.inState.click), o.isInStateTrue() ? o.enter(o) : o.leave(o)) : o.tip().hasClass("in") ? o.leave(o) : o.enter(o);
            }),
