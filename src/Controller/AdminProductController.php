...
use App\Manager\SpreadSheetManager;
...
class AdminProductController extends AbstractController
{
    ...
    protected $spreadSheetManager;

    public function __construct(EntityManagerInterface $em, ProductRepository $repoProduct, UserRepository $repoUser, SubscriptionPlanRepository $repoPlan, OrderRepository $repoOrder, ProductService $productService, SpreadSheetManager $spreadSheetManager)
    {
        $this->em = $em;
     ...
     */
    public function admin_product_excel_export_file(){
        return $this->spreadSheetManager->persistExportCsv();
    }
